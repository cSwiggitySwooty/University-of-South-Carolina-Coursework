...
public class UserInterface {
	...
	public ArrayList<Property> searchProperties() {
		...
		s.nextLine();
		ArrayList<Property> ret = search(numBed, numBath, ptype, amenities, price);
		return ret;
	}
	
	public ArrayList<Property> search(int beds, int baths, PropertyType ptype, ArrayList<String> amenities, double price) {
